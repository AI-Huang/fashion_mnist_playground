...
class MLP:
    ...
    def feature_extractor(self):
        ...
        self.features = tf.reshape(endpoints[self.resnet_version+'/block4'], [tf.shape(self.imgs)[0], 2048])
    ...
    def save(self, i):
        save_path = self.model_dir+'/mnist'
...
def train(resnet_version, random_labels, freeze_before_k):
    ...
    mnist = input_data.read_data_sets('fashion-mnist/data/fashion') # load fashion mnist
    ...
    data_set_size = 50000 # use all of training set
    n_epochs = n_epochs * mnist.train._labels.shape[0] / data_set_size # data_set_size
...
resnet_versions = ['resnet_v1_200', 'resnet_v1_152' , 'resnet_v1_101', 'resnet_v1_50', 'resnet_v2_50', 'resnet_v2_101' , 'resnet_v2_152' , 'resnet_v2_200' , 'vgg_a' , 'vgg_16' , 'vgg_19']
for res_i in resnet_versions:
